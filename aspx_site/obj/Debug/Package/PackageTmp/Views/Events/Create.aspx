...
<h2>Create New Event</h2>
 ...
 <table id="createform">
    ...
    <tr><td>Event Start:</td> <td><%: Html.TextBox("EventStart", ViewData["EventStart"], new { @class = "textinput" })%></td></tr>
    <tr><td>Event End:</td> <td><%: Html.TextBox("EventEnd", ViewData["EventEnd"], new { @class = "textinput" })%></td></tr>
